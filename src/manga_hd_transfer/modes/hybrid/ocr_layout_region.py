...
"""Mode-private geometry recovery for OCR lettering containers.
...
This deliberately uses only TARGET pixels and local geometry.  It never invokes a
renderer from another Folirina mode.
"""
