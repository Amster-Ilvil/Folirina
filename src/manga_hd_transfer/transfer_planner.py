...
def choose_transfer_strategy(
    ...
    *,
    ...
    return TransferDecision(
        mode, mode, bool(contract.may_fallback_to_mask or contract.may_fallback_to_reletter), "explicit_mode",
        same_page_confidence, direct_plan_safe, {**base_evidence, "mode_contract": contract.to_dict()}, common_actions,
    )
