...
def export_openraster(
    ...
    SubElement(stack, "layer", {"name": "Inpainted", "src": "data/inpainted.png"})
    ...
    with zipfile.ZipFile(p, "w") as zf:
        ...
        for name in ("original.png", "inpainted.png", "text.png"):
...
def export_psd_imagemagick(
    ...
    cmd = [
        ...
        str(inpainted_path), "-set", "label", "Inpainted",
        str(text_path), "-set", "label", "Chinese text",
        str(p),
    ]
