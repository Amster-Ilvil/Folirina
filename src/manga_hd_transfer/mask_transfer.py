...
from .text_only_transfer import target_text_mask_in_container, cleanup_target_residual_specks
    ...
    for match in matches:
        ...
        if should_try_ink:
            ...
            if not used_reconstruction and (fidelity == "ink" or small_text_photo_pair or (fidelity == "auto" and too_soft)):
                if cfg.reject_blurry_source and _publication_safety_enabled(cfg):
